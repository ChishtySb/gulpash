...
ON CONFLICT (id) DO NOTHING;
INSERT INTO public.products (id, title, slug, description, sku, category_id, category_name, price, compare_at_price, fabric, tags, sizes, is_visible, is_best_seller, is_new_arrival, is_sold_out, stock)
VALUES ('24fcf3b0-026f-4c86-84ea-f38b335abfcc', 'IZNA 3PC', 'izna-3pc', '<p data-end="125" data-start="81"><strong data-end="125" data-start="81">Izna 3pcs ✨ | Tawakal Closet</strong></p>
...
ON CONFLICT (id) DO NOTHING;
INSERT INTO public.products (id, title, slug, description, sku, category_id, category_name, price, compare_at_price, fabric, tags, sizes, is_visible, is_best_seller, is_new_arrival, is_sold_out, stock)
VALUES ('fa17e1b8-89a6-4e2c-84f7-932253a1a588', 'Elsa Embroidery 3pcs', 'elsa-embroidery-3pcs', '<p data-start="81" data-end="125"><strong data-start="81" data-end="125">Elsa 3pcs Suit – Zinc ✨ | Tawakal Closet</strong></p>
...
<p data-start="821" data-end="909">#TawakalCloset #DhankFabric #3PcsSuit #ChiffonDupatta #ElegantWear #NewArrival #ZincSuit</p>', 'TAW-EE3-S', '90151ef9-20ad-496b-8daf-eef1fb0a8aa9', 'Unstitched / Stitched', 5999, 7399, 'Premium Cotton Lawn / Raw Silk', '{}', '{"Standard Size"}', true, true, true, false, 100)
ON CONFLICT (slug) DO UPDATE SET title = EXCLUDED.title, description = EXCLUDED.description, price = EXCLUDED.price, compare_at_price = EXCLUDED.compare_at_price;
INSERT INTO public.product_images (id, product_id, image_url, alt_text, is_primary, display_order)
